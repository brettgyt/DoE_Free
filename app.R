                                                                  ...
                                                                  sidebarLayout(
                                                                      sidebarPanel(
                                                                           ...
                                                                           textInput("mix.comp.input",
                                                                                    ...
                                                                                    placeholder = "Component Name Cannot be a Number"),
                                                       ...
                                                       sidebarLayout(
                                                           sidebarPanel(
                                                               ...
                                                               fileInput("upload.mix",
                                                                         ...
                                                                         buttonLabel = "Upload Design",
                                                                         accept = c(".csv", ".tsv")),
                                                               ## ## fileInput(u"pload.ccd.responses",
                                                               ## ##           NULL,
                                                               ## ##           buttonLabel = "Upload Responses",
                                                               ## ##           accept = c(".csv", ".tsv"),
                                                               ## ##           placeholder = "Results w/ 'Run'")
...
################
     navbarMenu("Screening",
                                 tabPanel("Fractional Factorial Design",
                                          tags$h1("Fractional Factorial Design"),
                                           tabsetPanel(
                                              navbarMenu("Create Fractional Factorial Design",
                                                         tabPanel("Create Design",
                                                                  sidebarLayout(
                                                                      sidebarPanel(
                                                                          helpText("Enter the Factors in your Fractional Factorial Design"),
                                                         ...
                                                         tabPanel("Design Information",
                                                                  ...
                                                                  mainPanel(
                                                                      helpText("Resolution Table for Fractional Factorial Design"),
                      ...
                      tabPanel("Instructions", "ins.cont")
                      ),
...
server <- function(input, output, session) {
    ...
    ##         mod.ccd.0 <- lm(data = df,
    ##                         response = "T.neg.3",
    ##                         mixcomps = mixcomps,
    ##                         procvars = procvars,
    ##                         model = mix.mod.type.number)

    ##         mod.ccd.1 <- lm(data = df,
    ##                         response = "T.neg.2",
    ##                         mixcomps = mixcomps,
    ##                         procvars = procvars,
    ##                         model = mix.mod.type.number)
    ...
    ffd.joined <- reactive({
        ...
        if(nrow(resp.column[1]) != nrow(ffd.df())) {

            mean.resp <- mean(resp.column[1])
            
            test.df <-  data.frame(Run = 1:nrow(ffd.design.rebuilt())) %>%
                filter(!(Run %in% resp.column$Run)) %>%
                mutate(Response = mean.resp)
